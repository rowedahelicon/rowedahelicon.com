<div id="fursona-image" class="border-b-4 border-[#043138]">
    <img src="https://www.rowedahelicon.com/images/stargazer.webp" title="A portrait image of Rowdy, starring up and over towards the screen, looking up at the starry sky. They have a flower in their hair, and are wearing abright blue collar around their neck." alt="Rowdy observing the stars">
</div>
<main class="p-4">
    <div class="space-y-5">
        <div class="text-center">
            <span class="text-3xl">Rowedahelicon</span>
            <br>
            <span class="text-gray-400 text-2xl">(Row-ay-dah-hell-eh-con)</span>
            <br>
            <span class="text-gray-500 text-xl opacity-75">Rowe (Renowned Wolf) • Edah (Witness) • Helicon (Twisted)</span>
        </div>
        <section id="fursona-bio" class="pb-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
                <div class="text-normal">
                    <h2 class="header-2 text-4xl aero">Bio</h2>
                    <b>Nicknames:</b> <span class="float-right">Rowdy, Rowbles, Rumble</span><br>
                    <b>Age:</b> <span class="float-right">32</span><br>
                    <b>DoB:</b> <span class="float-right">June 12th, 1992</span><br>
                    <b>Species:</b> <span class="float-right"><a href="https://en.wikifur.com/wiki/Crux_(species)">Leukos Arsenikon Crux</a></span><br>
                </div>
                <div class="text-normal">
                    <h2 class="header-2 text-4xl aero">Traits</h2>
                    <b>Personality:</b> <span class="float-right"><a href="https://www.16personalities.com/infp-personality">INFP-T</a> / <a href="https://www.crystalknows.com/enneagram/type-4/wing-5">4 Wing 5</a></span><br>
                    <b>Interests:</b> <span class="float-right">Philosophy, Science, Design, Film, Gaming</span><br>
                    <b>Notes:</b> <span class="float-right"><a href="https://en.wikipedia.org/wiki/Night_owl_(person)">Nocturnal</a>, <a href="https://en.wikipedia.org/wiki/Color_blindness#Red-green_color_blindness">Partially Colorblind</a></span><br>
                    <b>Identifiers:</b> <span class="float-right">They/It, <a href="https://en.wikipedia.org/wiki/Furry_fandom">Furry</a>, <a href="https://en.wikipedia.org/wiki/Pansexuality">Pansexual</a>, <a href="https://en.wikipedia.org/wiki/Pantheism">Pantheistic</a></span><br>
                </div>
            </div>
            <br>
            <br>
            <h2 class="header-2 text-4xl aero">Reference</h2>
            <div class="p-4">
                <h3 class="header-2 text-3xl aero">Physical</h3>
                <div class="p-4">
                    <ul class="list-disc">
                        <li>Genderless, no sexual / reproductive organs whatsoever.</li>
                        <li>It stands at 6 feet even, and has a crooked tail spanning roughly five and a half feet.</li>
                        <li>Its ears span roughly one and a half feet tall.</li>
                        <li>It is lithe, weighing only around 135LBS / 61KG.</li>
                        <li>Messy, shoulder-length, unkept dark hair. Sometimes draped over and covering one eye.</li>
            ...
            <div class="p-4">
                <h3 class="header-2 text-3xl aero">Emotional</h3>
                <div class="p-4">
                    <ul class="list-disc">
                        <li>Timid, shy, but generally social in familiar situations.</li>
                        <li>Enjoys being social, but can stay comfortably isolated for long periods of time.</li>
                        <li>Creature of the night, hates the daylight.</li>
                        <li>Scatterbrained and child-like at times.</li>
